<?php
/*
Uses Will Norriss's Hum shortlinks with some small modifications.
 */
...
function lh_hum_redirect_local( $type, $id ) {
  $local_types = array('b', 't');
  $local_types = apply_filters('hum_local_types', $local_types);
...
function lh_hum_permalink($permalink){
